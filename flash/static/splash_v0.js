		...
		function animate_strand () {
			...
			nucleotides[i].animate({transform:"t"+dx+",0"}, 2000, "<");
		    }
		}
		var lang = []

		function show_text () {
		    var lang_txt = ["English", "Francais","Mobile"];
		    var lang_url = ["http://phylo.cs.mcgill.ca/eng/play.html", "http://phylo.cs.mcgill.ca/fr/play.html","http://phylo.cs.mcgill.ca/mobile/"]
		    for (var i=0;i<3;++i){
