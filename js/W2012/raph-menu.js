...
menu = [[lang[0].header["field 1"], "index.html"+hash], [lang[0].header["field 2"], '?pid=tutorial'+hash], [lang[0].header["field 3"], '?pid=about'+hash], [lang[0].header["field 4"], '?pid=credits'+hash]];
...
var redline = paper.rect(0, nwidth/2+15+yoffset, w, 10).attr({fill:"#D23727", stroke:"#D23727"});
    ...
    // make logo
var hash = window.location.hash;
var logo = paper.rect(w*0.20, -10, logo_width, 80, 20).attr({fill:"#303030", stroke:"#303030", "href":"index.html"+hash});
var logo_text = paper.text(w*0.20 + logo_width*0.5, 25, "phylo").attr({fill:"#eee", "stroke-width":0,"font-family": font, "font-size":40, "href":"index.html"+hash});
logo.pair = logo_text;
logo_text.pair = logo;
logo.hover(
        function (event) {
