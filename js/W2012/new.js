(function() {
	...
	(function() {
		...
		g.prototype.loadMenu = function(doc,win,settings) {
			...
			banner.src = 'http://phylo.cs.mcgill.ca/img/phylo_logo.png';
			...
			var menuStr = [window.lang[0].body.play.gameselect.levelselect.random["field 2"],window.lang[0].body.play.gameselect.levelselect["level id"]["field 2"],window.lang[0].body.play.gameselect.levelselect.disease["field 1"]];
					...
					&& y-5 <= eY && eY <= y+5+settings.box()*1.3) {
						switch(i) {
							case 1:
								...
								ctx.fillStyle = "white";
								ctx.font = "20pt Helvetica";
								ctx.fillText(lang[0].body.play.gameselect.levelselect["level id"]["field 3"], 245, 100);
								ctx.closePath();
							...
							case 2:
								...
								ctx.fillStyle = "white";
								ctx.font = "20pt Helvetica";	
								ctx.fillText(lang[0].body.play.gameselect.levelselect.disease["field 1"],settings.width()/2, 100);
								ctx.textAlign = "left";
								ctx.closePath();
								selection = [];
								//selection.push(new login(ctx));
							...
							case 0:
								...
								ctx.fillStyle = "white";
								ctx.font = "20pt Helvetica";	
								ctx.fillText(lang[0].body.play.gameselect.levelselect.random["field 1"], settings.width()/2,120);
								ctx.fillText(lang[0].body.play.gameselect.levelselect.random["field 3"], settings.width()/2,240);
								ctx.textAlign = "left";
								ctx.closePath();
								selection = [];
								selection.push(new login(ctx));
			...
			var levelselect = function(ctx) {	
				...
				ctx.font = '19pt Helvetica';
				ctx.textAlign = "center";
				ctx.fillText(lang[0].body.play.gameselect.levelselect["level id"]["field 4"],335,252);
				ctx.textAlign = "left";
				ctx.restore();
				ctx.closePath();
				this.onClick = function(eX, eY) {
			...
			var back = function(ctx) {
				...
				ctx.font = '19pt Helvetica';
				ctx.textAlign = "center";
				ctx.fillText(lang[0].header["field 9"],175,-165);
				ctx.textAlign = "left";
				ctx.restore();
				ctx.closePath();
				this.onOver = function(eX,eY) {
