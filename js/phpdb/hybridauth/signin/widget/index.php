...
<head>
    <title>Phylo Social Sign-on powered by HybridAuth</title> 
	<style>
		.idpico{
			cursor: pointer;
			cursor: hand;
		...
		$(function() { 
			$(".idpico").click(
				function(){ 
					...
					switch( idp ){
						case "google"  : case "twitter" : case "facebook" : 
						case "linkedin" : 
						...
						default: alert( "Sign-in provider is not supported" );
					}
				}
			); 
			...
			$("#openidbtn").click(
				function(){
					...
					if( ! un ){
						alert( "Please, provide your username in this input field." );
						return false;
					}
