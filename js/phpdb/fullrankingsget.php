...
<?
echo "<li class=\"active all\"><a id=\"showall\" href=\"#\">" . $buttonname1 . "</a></li>";
echo "<li class=\"month\"><a id=\"showmonth\" href=\"#\">" . $buttonname2 . "</a></li>";
echo "<li class=\"week\"><a id=\"showweek\" href=\"#\">" . $buttonname3 . "</a></li>";
?>
</div>

<div id="alltime">
<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-condensed" id="rankingtable" width="100%">
<thead>
<?
